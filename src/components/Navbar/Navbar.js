...
function Navbar() {
    ...
    const useStyles = makeStyles((t) => ({
        navMenu: {
            ...
            [t.breakpoints.down('sm')]: { fontSize: '2.5rem' },
            [t.breakpoints.down('xs')]: { fontSize: '2rem' },
        },
        MuiDrawer: {
            padding: '0em 1.8em',
            width: '14em',
            ...
            borderTopRightRadius: '40px',
            borderBottomRightRadius: '40px',
            [t.breakpoints.down('sm')]: { width: '12em' },
        },
        closebtnIcon: {
            fontSize: '2rem',
            fontWeight: 'bold',
            ...
            [t.breakpoints.down('sm')]: { right: 20, top: 20 },
        },
        drawerItem: {
            margin: '2rem auto',
            borderRadius: '78.8418px',
            ...
            [t.breakpoints.down('sm')]: { width: '100%', padding: '0 25px', height: '55px' },
        },
        drawerLinks: {
            fontFamily: 'var(--primaryFont)',
            width: '50%',
            fontSize: '1.3rem',
            fontWeight: 600,
            [t.breakpoints.down('sm')]: { fontSize: '1.125rem' },
        },
        drawerIcon: {
            fontSize: '1.6rem',
            [t.breakpoints.down('sm')]: { fontSize: '1.385rem' },
        },
    }));
